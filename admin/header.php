...
<head>
    ...
    <meta name="keyword" content="FlatLab, Dashboard, Bootstrap, Admin, Template, Theme, Responsive">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" <?= $page == 'add_category.php' ? 'class="active"':'' ?> >
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" <?= $page == 'add_blog.php' ? 'class="active"':'' ?> >
                          <i class="fa fa-laptop"></i>
                          <span>Blog</span>
                      </a>
                      <ul class="sub">
